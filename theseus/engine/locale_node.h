// locale_node.h: locale / region / language enums and translation API
// declarations consumed by CLocale (locale_node.cpp). Locales pack
// region in the high 16 bits and language in the low 16 bits.
